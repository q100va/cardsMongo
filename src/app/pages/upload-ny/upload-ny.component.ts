...
export class UploadNyComponent implements OnInit {
  ...
  sendEmail() {
    ...
    "<div>Спасибо вам преогромное!<br>___________________________________________________________<br>Помогите обеспечить горячей едой пожилых людей:<br><a href = 'https://starikam.org/campaign/lyudyam-nuzhna-goryachaya-eda/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
