...
export class UploadNyComponent implements OnInit {
  ...
  sendEmail() {
    ...
    "<div>Спасибо вам преогромное!<br>___________________________________________________________<br>Сайт БФ 'Старость в радость':<br><a href = 'https://starikam.org/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
