...
export class UploadNyComponent implements OnInit {
  ...
  sendEmail() {
    ...
    const subscribersTopText =
      "Прошу вас отправить открытки в середине ноября - начале декабря и только простыми отправлениями.\n\n" +
      this.holiday +
      "\n\n";
    ...
    const subscribersTopHtml =
      "<div>Прошу вас отправить открытки в середине ноября - начале декабря и только простыми отправлениями.</div><br><p style='font-weight: bold;'>" +
      this.holiday +
      "</p>";
