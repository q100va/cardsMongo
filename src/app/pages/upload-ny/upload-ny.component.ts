...
export class UploadNyComponent implements OnInit {
  ...
  sendEmail() {
    ...
    "<div>Спасибо вам преогромное!<br>___________________________________________________________<br>Помогите купить специальные кресла и ванны-тележки:<br><a href = 'https://starikam.org/campaign/bezopasnyj-dush-i-vanna-s-penoj/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
