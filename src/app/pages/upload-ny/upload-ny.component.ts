...
export class UploadNyComponent implements OnInit {
  ...
  sendEmail() {
    ...
    "<div>Спасибо вам преогромное!<br>___________________________________________________________<br>Поучаствовать в сборе на новогодние гостинцы можно по ссылке:<br><a href = 'https://ng.starikam.org/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
