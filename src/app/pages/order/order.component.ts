...
export class OrderComponent implements OnInit {
  ...
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения августа 2024";
  lineItems = [];
  types: Array<string> = [
    "email",
    "phoneNumber",
  ...
  goNext(event) {
    ...
    if (this.isNextMonth) {
      this.holiday = "Дни рождения сентября 2024";
    }
  }
