...
export class OrderComponent implements OnInit {
  ...
  fillOrder(prohibitedId: [], restrictedHouses: []) {
    ...
    if (this.holiday == "Дни рождения октября 2025") {
      this.holidayTitle = "Дни рождения 26-31 октября 2025";
    ...
    if (this.holiday == "Дни рождения ноября 2025") {
      this.holidayTitle = "Дни рождения 11-15 ноября 2025";
      if (this.form.controls.date1.value && this.form.controls.date2.value) {
        this.holidayTitle =
          "Дни рождения " +
          this.form.controls.date1.value +
      ...
      if (
        !this.form.controls.date1.value &&
        this.form.controls.date2.value &&
        this.form.controls.date2.value >= 15
      ) {
        this.holidayTitle =
          "Дни рождения 11" +
          "-" +
    ...
    if (this.holiday == "Дни рождения декабря 2025") {
      this.holidayTitle = "Дни рождения 1-5 декабря 2025";
      if (this.form.controls.date1.value && this.form.controls.date2.value) {
        this.holidayTitle =
          "Дни рождения " +
          this.form.controls.date1.value +
   ...
   /*      "Просим вас учитывать, что почтовые тарифы повышены с 10 февраля 2025 г.\n" + */
    ...
    if (!this.isForInstitutes) {
      ...
      bottom =
        ...
        "Помогите обеспечить горячей едой одиноких пожилых людей,  https://starikam.org/campaign/lyudyam-nuzhna-goryachaya-eda/\n\n" +
    ...
    let bottomForSubscribers =
      "Многократно благодарим вас!\n" +
      "_________________________________________________\n" +
      "Помогите обеспечить горячей едой одиноких пожилых людей:\n" +
