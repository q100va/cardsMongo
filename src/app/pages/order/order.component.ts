...
export class OrderComponent implements OnInit {
  ...
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения октября 2024";
  lineItems = [];
  types: Array<string> = [
    "email",
    "phoneNumber",
