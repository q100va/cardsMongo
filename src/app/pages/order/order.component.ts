...
/* 
  ...
  goNext(event) {
    ...
    if (this.isNextMonth) {
      this.holiday = "Дни рождения августа 2026";
    }
  }
  ...
  fillOrder(prohibitedId: [], restrictedHouses: []) {
    ...
    /*  if (this.holiday == "Дни рождения июня 2026") {
    ...
    if (this.holiday == "Дни рождения июля 2026") {
    ...
    if (this.holiday == "Дни рождения августа 2026") {
