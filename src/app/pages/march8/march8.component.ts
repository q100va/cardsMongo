...
@Component({
  selector: "app-march8",
  templateUrl: "./march8.component.html",
  styleUrls: ["./march8.component.css"],
})
export class March8Component implements OnInit {
  order: Order;
  userName: string;
  form: FormGroup;
  ...
  getAddresses() {
    ...
    let topForSubscribers =
      "Обращаем ваше внимание, что почтовые тарифы повышены с 10 февраля 2025 г.\n" +
      "Просим вас отправить открытки примерно за месяц до праздника.\n\n";
    ...
    if (!this.isForInstitutes || this.isParcelAvailable) {
      ...
      topForSubscribers =
        topForSubscribers +
        "На конверте рекомендуем указать название праздника. Например, '8 марта'.\n\n" +
