...
/*       email:
  ...
  getAddresses() {
    ...
    let top =
      ...
      this.holiday + " (открытки просим отправить не ранее середины декабря - примерные сроки на https://www.pochta.ru/letters - и только простыми отправлениями) "
      "\n" +
    ...
    let bottom =
      ...
      "Помогите нам подарить новогодние подарки и угощенья 102 400 бабушкам и дедушкам https://ng.starikam.org/ \n\n" +
