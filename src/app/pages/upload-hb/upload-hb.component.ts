...
/*     const subscribersTopHtml =
    ...
    "<div>Спасибо вам огромнейшее!<br>___________________________________________________________<br>Помогите поздравить с Новым годом одиноких пожилых людей:<br><a href = 'https://ng.starikam.org/2026'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
