...
@Component({
  selector: "app-upload-hb",
  templateUrl: "./upload-hb.component.html",
  styleUrls: ["./upload-hb.component.css"],
  //changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UploadHbComponent implements OnInit {
  emailOrders = [];
  order: Order;
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения декабря 2025";
  lineItems = [];
  types: Array<string> = [
    "email",
    /*     "phoneNumber",
  ...
  goNext(event) {
    ...
    console.log("click");
    if (this.isMainMonth) {
      this.holiday = "Дни рождения декабря 2025";
    }
    if (this.isNextMonth) {
      this.holiday = "Дни рождения декабря 2025";
    }
  ...
  goBack(event) {
    ...
    if (this.isBeforeMonth) {
      this.holiday = "Дни рождения ноября 2025";
    }
  }
  ...
  sendEmail() {
    ...
    /* const subscribersTopText =
      "Открытки нужно отправить примерно за месяц до праздника или дня рождения.На конверте рекомендуем делать пометку 'прошу вручить + дата'.\nОбращаю ваше внимание, что списки поздравляемых идут без фамилий.\n\n" + this.holiday + "\n\n"; */

      const subscribersTopText =
      "Открытки нужно отправить в ближайшие дни. На конверте рекомендуем сделать пометку 'прошу вручить + дата'.\nОбращаю ваше внимание, что списки поздравляемых идут без фамилий.\n\n" + this.holiday + "\n\n";

    const subscribersBottomText =
    "Спасибо вам огромнейшее!\n_________________________________________________\nПомогите обеспечить горячей едой пожилых людей:\nhttps://starikam.org/campaign/lyudyam-nuzhna-goryachaya-eda/\n\n";
...
/*     const subscribersTopHtml =
    ...
    "Открытки нужно отправить примерно за месяц до праздника или дня рождения.На конверте рекомендуем делать пометку 'прошу вручить + дата'.<br />Обращаю ваше внимание, что списки поздравляемых идут без фамилий." +
      ...
      const subscribersTopHtml =
      "<p style='font-style: italic;'>" + 
      "Открытки нужно отправить в ближайшие дни. На конверте рекомендуем сделать пометку 'прошу вручить + дата'.<br />Обращаю ваше внимание, что списки поздравляемых идут без фамилий." +
        "</p>" + "<p style='font-weight: bold;'>" +
        this.holiday +
        "</p>";
    ...
    "<div>Спасибо вам огромнейшее!<br>___________________________________________________________<br>Помогите обеспечить горячей едой пожилых людей:<br><a href = 'https://starikam.org/campaign/lyudyam-nuzhna-goryachaya-eda/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
    ...
    const subscribersInstituteBottomHtml =
      "<br><div><span style='font-weight: bold; color: rgb(31, 86, 168)'>Отправляйте письма правильно!</span><br> – Открытки отправляйте Почтой России только ПРОСТЫМИ бандеролями (от 100 г до 5 кг) или ПРОСТЫМИ письмами (до 100 г).<br> – Рассчитывайте, что срок доставки может составить более 30 дней.<br> – В графе 'кому' указывайте название интерната (учреждения). Указывать ФИО получателя совершенно не обязательно.<br> – На конверте/пакете укажите название праздника/праздников, особенно это актуально для дней рождений. (Например, 'Дни рождения декабря').</div><br>" +
      ...
      "<div>Спасибо вам преогромное!</div><br>" +
      "<div>_______________________________________________________________________________________<br>Помогите обеспечить горячей едой пожилых людей:<br><a href = 'https://starikam.org/campaign/lyudyam-nuzhna-goryachaya-eda/'>Давайте дарить тепло и радость уже сейчас!</a> </div><br>";
