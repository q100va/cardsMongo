...
export class UploadHbComponent implements OnInit {
  ...
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения января 2026";
  lineItems = [];
  types: Array<string> = [
    "email",
    /*     "phoneNumber",
  ...
  sendEmail() {
    ...
    "Спасибо вам огромнейшее!\n_________________________________________________\nПомогите купить специальные кресла и ванны-тележки:\n https://starikam.org/campaign/bezopasnyj-dush-i-vanna-s-penoj/ \n\n";
...
/*     const subscribersTopHtml =
    ...
    "<div>Спасибо вам огромнейшее!<br>___________________________________________________________<br>Помогите купить специальные кресла и ванны-тележки:<br><a href = 'https://starikam.org/campaign/bezopasnyj-dush-i-vanna-s-penoj/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
    ...
    const subscribersInstituteBottomHtml =
      ...
      "<div>_______________________________________________________________________________________<br>Помогите купить специальные кресла и ванны-тележки:<br><a href = 'https://starikam.org/campaign/bezopasnyj-dush-i-vanna-s-penoj/'>Давайте дарить тепло и радость уже сейчас!</a> </div><br>";
