...
export class UploadHbComponent implements OnInit {
  ...
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения июля 2026";
  lineItems = [];
  types: Array<string> = [
    "email",
    /*     "phoneNumber",
  ...
  goNext(event) {
    ...
    console.log("click");
    if (this.isMainMonth) {
      this.holiday = "Дни рождения июля 2026";
    }
    if (this.isNextMonth) {
      this.holiday = "Дни рождения июля 2026";
    }
  ...
  goBack(event) {
    ...
    if (this.isBeforeMonth) {
      this.holiday = "Дни рождения июня 2026";
    }
  }
...
/*     const subscribersTopHtml =
    ...
    "<div>Спасибо вам огромнейшее!<br>___________________________________________________________<br>Сайт БФ 'Старость в радость':<br><a href = 'https://starikam.org/'>Давайте дарить тепло и радость уже сейчас!</a></div><br>";
    ...
    const subscribersInstituteBottomHtml =
      ...
      "<div>_______________________________________________________________________________________<br>Сайт БФ 'Старость в радость':<br><a href = 'https://starikam.org/'>Давайте дарить тепло и радость уже сейчас!</a> </div><br>";
  ...
  getAddresses() {
    ...
    if (!this.isForInstitutes) {
      ...
      bottom =
        ...
        "Сайт БФ 'Старость в радость' - https://starikam.org/\n\n" +
