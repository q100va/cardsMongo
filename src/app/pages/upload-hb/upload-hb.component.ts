...
export class UploadHbComponent implements OnInit {
  ...
  sendEmail() {
    ...
    const subscribersTopText =
      "С благодарностью отправляю вам адреса!\n\n" + this.holiday + "\n\n";
    const subscribersBottomText =
      "_________________________________________________\nВы можете купить нужные товары для фонда через Ozon\nпо ссылке https://www.ozon.ru/highlight/pokupayu-pomogayu-1804052/?miniapp=supermarket\n\n";
    ...
    const subscribersInstituteBottomText =
      ...
      "Вы можете купить нужные товары для фонда через Ozon/nпо ссылке https://www.ozon.ru/highlight/pokupayu-pomogayu-1804052/?miniapp=supermarket \n\n" +
    ...
    const subscribersTopHtml =
      "<div>С благодарностью отправляю вам адреса!</div><br><p style='font-weight: bold;'>" +
      this.holiday +
      "</p>";
    const subscribersBottomHtml =
      "<div>___________________________________________________________<br>Вы можете купить нужные товары для фонда через Ozon<br>по ссылке <a href = 'https://www.ozon.ru/highlight/pokupayu-pomogayu-1804052/?miniapp=supermarket'>Покупаю — помогаю — интернет-магазин OZON</a></div><br>";
    ...
    const subscribersInstituteBottomHtml =
      ...
      "<div>_______________________________________________________________________________________<br>Вы можете купить нужные товары для фонда через Ozon<br>по ссылке <a href = 'https://www.ozon.ru/highlight/pokupayu-pomogayu-1804052/?miniapp=supermarket'>Покупаю — помогаю — интернет-магазин OZON</a> </div><br>";
