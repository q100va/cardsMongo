...
export class UploadHbComponent implements OnInit {
  ...
  userName: string;
  form: FormGroup;
  holiday: string = "Дни рождения августа 2025";
  lineItems = [];
  types: Array<string> = [
    "email",
    /*     "phoneNumber",
  ...
  goNext(event) {
    ...
    console.log("click");
    if (this.isMainMonth) {
      this.holiday = "Дни рождения августа 2025";
    }
    if (this.isNextMonth) {
      this.holiday = "Дни рождения августа 2025";
    }
...
/*     const subscribersTopHtml =
    ...
    const subscribersInstituteBottomHtml =
      ...
      "<div>_______________________________________________________________________________________<br>Поучаствовать в сборе на новогодние гостинцы можно по ссылке:<br><a href = 'https://ng.starikam.org/'>Давайте дарить тепло и радость уже сейчас!</a> </div><br>";
