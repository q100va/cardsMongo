...
async function deletePluses(deletedOrder, full) {
  ...
  if (deletedOrder.holiday == "Дни рождения ноября 2025" || deletedOrder.holiday == "Дни рождения декабря 2025" || deletedOrder.holiday == "Дни рождения октября 2025") {
    ...
    for (let lineItem of deletedLineItems) {
      for (let person of lineItem.celebrators) {
        if (person.monthBirthday == monthNumber) {
          ...
          if (deletedOrder.holiday == "Дни рождения ноября 2025") {
...
async function restorePluses(updatedOrder) {
  if (updatedOrder.holiday == "Дни рождения ноября 2025" || updatedOrder.holiday == "Дни рождения декабря 2025" || updatedOrder.holiday == "Дни рождения октября 2025") {
    ...
    for (let lineItem of updatedOrder.lineItems) {
      for (let person of lineItem.celebrators) {
        if (person.monthBirthday == month.number) {
          ...
          if (updatedOrder.holiday == "Дни рождения ноября 2025") {
  ...
  try {
    ...
    if (req.params.holiday == "birthday") {
      ...
      for (let celebrator of celebratorsHB) {
        let plusAmount = await Order.find({ "lineItems.celebrators._id": celebrator._id, isDisabled: false, isOverdue: false, isReturned: false, holiday: "Дни рождения ноября 2025" }).countDocuments();
