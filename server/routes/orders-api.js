...
async function deletePluses(deletedOrder, full) {
  ...
  if (deletedOrder.holiday == "Дни рождения февраля 2025" || deletedOrder.holiday == "Дни рождения марта 2025" || deletedOrder.holiday == "Дни рождения января 2025") {
...
async function restorePluses(updatedOrder) {
  if (updatedOrder.holiday == "Дни рождения февраля 2025" || updatedOrder.holiday == "Дни рождения марта 2025" || updatedOrder.holiday == "Дни рождения января 2025") {
