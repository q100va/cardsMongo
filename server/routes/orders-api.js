...
async function deletePluses(deletedOrder, full) {
  ...
  if (deletedOrder.holiday == "Дни рождения мая 2026" || deletedOrder.holiday == "Дни рождения июня 2026" || deletedOrder.holiday == "Дни рождения апреля 2026") {
...
async function restorePluses(updatedOrder) {
  if (updatedOrder.holiday == "Дни рождения мая 2026" || updatedOrder.holiday == "Дни рождения июня 2026" || updatedOrder.holiday == "Дни рождения апреля 2026") {
