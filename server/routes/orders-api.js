...
async function deletePluses(deletedOrder, full) {
  ...
  if (deletedOrder.holiday == "Дни рождения октября 2025" || deletedOrder.holiday == "Дни рождения ноября 2025" || deletedOrder.holiday == "Дни рождения сентября 2025") {
...
async function restorePluses(updatedOrder) {
  if (updatedOrder.holiday == "Дни рождения октября 2025" || updatedOrder.holiday == "Дни рождения ноября 2025" || updatedOrder.holiday == "Дни рождения сентября 2025") {
